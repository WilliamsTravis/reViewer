        ...
        html.Div([
          ...
          html.Div([
              dcc.Link(
                  html.Button(
                    id="app_link_button",
                    children="Application Page",
                    type='button',
                    title=('Click to return to the main application page.'),
                    style={"display": "none"},
                    ),
                  id="app_link",
                  href='/apps/main_page',
              ...
              dcc.Link(
                  html.Button(
                    ...
                    type='button',
                    title=('Click to go to the data configuration page.'),
                    style={"display": "none"}
                  ),
                  id="config_link",
              ...
              dcc.Link(
                  html.Button(
                    ...
                    type='button',
                    title=('Click to go to the portal testing page.'),
                    style={"display": "none"}
                  ),
                  id="test_link",
                  href="/apps/test_page"
